...
const Projects = [
  ...
  },
  {
    ...
    description:'<p>O objetivo principal do projeto é criar uma carteira de controle de gastos com a capacidade de converter para real gastos feitos em outras moedas.</p><h2>Habilidades</h2><p>Neste projeto, tive a oportunidade de demonstrar as seguintes habilidades:</p><ul><li>Configurar e conectar o Redux a uma aplicação React</li><li>Criar ações assíncronas na aplicação React que fazem uso de Redux</li></ul>',
    img: Avatar,
    id: 9,
